    ...
    <v-card :loading="loading" class="mx-auto my-12" max-width="700">
        <v-row>
            <v-col md="6">
                ...
                <div class="imgbx">
                    <v-img v-if="NewSignIn.imagen != null" cover class="rounded-lg rounded-br-0 rounded-tr-0"
                        :src="NewSignIn.imagen" height="100%">
                    </v-img>
                    <v-img v-else cover class="rounded-lg rounded-br-0 rounded-tr-0"
                        src="https://i.ytimg.com/vi/sju9XsN6Hb0/maxresdefault.jpg" height="100%">
                    </v-img>
                </div>
                ...
                <v-card-actions>
                    <v-container fluid>
                        ...
                        <v-text-field v-model="NewSignIn.password" label="Contraseña"
                            placeholder="Ingrese una contraseña." outlined
            ...
            <v-col md="6">
                <v-card-actions>
                    <v-container>
                        <v-row no-gutters>
                            <v-col cols="12">
                                <v-text-field label="Nombres" outlined v-model="NewSignIn.nombre"></v-text-field>
                            </v-col>
                        </v-row>
                        <v-row justify="center" no-gutters>
                            <v-col cols="6">
                                <v-text-field label="Apellido paterno" outlined v-model="NewSignIn.paterno">
                                </v-text-field>
                            </v-col>
                            <v-col cols="6">
                                <v-text-field label="Apellido materno" outlined v-model="NewSignIn.materno">
                                </v-text-field>
                            </v-col>
                        </v-row>
                        <v-row justify="center" no-gutters>
                        ...
                        <v-row ajustify="center" no-gutters>
                            <v-col cols="6">
                                <v-text-field label="C.I." outlined v-model="NewSignIn.idc"></v-text-field>
                            </v-col>
                            <v-col class="d-flex" cols="4">
                                <v-select :items="Extensiones" outlined v-model="NewSignIn.extidc"></v-select>
                            </v-col>
                            <v-col cols="2">
                        ...
                        <v-row ajustify="center" no-gutters>
                            <v-col class="d-flex" cols="12">
                                <v-select :items="TipoDoc" label="Tipo de documento" outlined
                                    v-model="NewSignIn.tipoidc"></v-select>
                            </v-col>
                        </v-row>
                        ...
                        <v-row justify="center" no-gutters>
                            ...
                            <v-col class="d-flex" cols="12">
                                <v-select :items="Role" outlined label="Seleccione su rol" v-model="NewSignIn.role">
                                </v-select>
                            </v-col>
                        </v-row>
                    </v-container>
                ...
                <v-card-actions>
                    <v-container>
                        <v-row justify="center">
                            ...
                            <v-col cols="7">
                                <v-btn depressed color="rgb(33,230,193)" block @click="postSignIn">
                                    Guardar
                                </v-btn>
                            </v-col>
                        </v-row>
...
export default {
    ...
    methods: {
        ...
        postSignIn() {
            ...
            this.$store.dispatch("addSignIn", this.NewSignIn)
                .then(
                    (response) => {
                    if (response) {
