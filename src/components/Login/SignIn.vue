    ...
    <v-card :loading="loading" class="mx-auto my-12" max-width="700">
        <v-row>
            <v-col md="6">
                ...
                <v-card-text>
                    <br>
                    <div>Registrate y disfruta de la mejor plataforma para ofrecer tus productos.</div>
                </v-card-text>
                ...
                <v-card-actions>
                    <v-container>
                        ...
                        <v-row justify="center" no-gutters>
                            <v-col cols="6">
                                <v-text-field label="Apellido paterno" outlined v-model="NewSignIn.paterno"></v-text-field>
                            </v-col>
                            <v-col cols="6">
                                <v-text-field label="Apellido materno" outlined v-model="NewSignIn.materno"></v-text-field>
                            </v-col>
                        </v-row>
                        <v-row justify="center" no-gutters>
                            <v-col>
